...
- `advisorCode` — base64 of the advisor access code. Default demo code: `IFOS-ADVISOR-2026`.
  To change it, run `btoa("YOUR-NEW-CODE")` in the browser console and paste the result.
...
- `?screen=admin` — advisor console with sample data
...
- **The advisor login is a placeholder.** The page is public client-side code, so a technical person could bypass the gate. Do not collect real sensitive client data with this version.
